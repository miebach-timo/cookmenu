...
Ein japanisch inspiriertes Dinner in acht Gängen für acht Personen — als animierter GSAP-One-Pager.
...
- **Nährwert-Tabs**: Pro Gang ein Tab-Menü („Makros" / „Vitamine") mit den Näherungswerten je Portion (1/8 des Rezepts) — kcal, Protein/Fett/Kohlenhydrate, Energieverteilungs-Balken, Detailwerte und Mikronährstoffe; per Tastatur bedienbar (Pfeiltasten) und ohne JavaScript vollständig lesbar
